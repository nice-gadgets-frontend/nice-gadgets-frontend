...
export const TabletsCatalogPage = () => {
  ...
  return (
    ...
    <div className="flex-1 mt-10 bg-black">
      ...
      <h1 className=" text-white font-extrabold text-3xl md:text-5xl font-[Mont-Regular]">Tablets</h1>
      <p className="text-gray-400 mb-6 text-sm font-semibold"> {sortedTablets.length}</p>
