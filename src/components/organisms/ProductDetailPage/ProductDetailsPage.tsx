...
export const ProductDetailPage: React.FC = () => {
  ...
  return (
    <main className="max-w-6xl mx-auto font-[Mont-Regular] text-primary">
      {/* breadcrumb */}
      ...
      <h1 className="text-3xl font-[Mont-Bold] mb-6">{product.name}</h1>
      ...
      <section className="max-w-[900px] ml-0 flex flex-col md:flex-row gap-16 mb-16">
        ...
        <div className="flex flex-col gap-6 max-w-[320px] md:flex-[0.45]">
          ...
          >
            ...
            <span className="line-through text-secondary font-[Mont-Regular]">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-10 mt-10">
        <section>
          <div className="mb-6">
            <h2 className="border-b border-b-[0.5px] border-elements pb-3 text-2xl font-bold">
              About
            </h2>
          </div>
          {product.description.map((section, idx) => (
            ...
            >
              ...
              {section.text.map((paragraph, pidx) => (
                <p
                  key={pidx}
                  className="leading-relaxed text-secondary mb-1"
                >
                  {paragraph}
                </p>
              ))}
